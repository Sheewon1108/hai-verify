...
**Version:** 1.0.0-mvp  
**Parent:** HAI Verify  
**IP pack:** `hai-ic/IP-PACK.md` · **Metrics:** `hai-ic/METRICS-PLAN.md` · **Modules:** `hai-ic/modules/`

## One line

**Before AI acts, measure Intent Confidence — Sincere Mode only at 75%+; human keeps final decision and responsibility.**
