/**
 * HAI-IC core analyzer — pure function, no network, no secrets.
 * Public entry: analyzeIntent(input)
 */
...
import { HAI_IC_CONFIDENCE_THRESHOLD, HAI_IC_DD_FLOOR } from "./constants";
import { HAI_IC_HOURLY_BOOST } from "./boost";
import { HAI_IC_DD_MAX_PENALTY_LIVE } from "./dd-penalty";

export { HAI_IC_PRODUCT_ID as HAI_IC_PRODUCT, HAI_IC_VERSION };
export type { HaiIcBreakdown, HaiIcResult };
...
/** Default analyzer implementation for plug-and-play hosts. */
export const haiIcAnalyzer: IHaiIcAnalyzer = {
