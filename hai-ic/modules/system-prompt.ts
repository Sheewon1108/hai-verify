import { HAI_IC_CONFIDENCE_THRESHOLD, HAI_IC_DD_FLOOR, HAI_IC_DD_MAX_PENALTY } from "./constants";
...
Human final decision and responsibility are always retained.`;

export { HAI_IC_CONFIDENCE_THRESHOLD, HAI_IC_DD_FLOOR, HAI_IC_DD_MAX_PENALTY };
