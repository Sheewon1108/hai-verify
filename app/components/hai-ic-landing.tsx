...
const DEFAULT_HAI_PAYMENT_LINK = 'https://buy.stripe.com/14A8wI6sV3CffST2UT4AU00';
const HAI_PAYMENT_LINK =
  process.env.NEXT_PUBLIC_HAI_PAYMENT_LINK ?? DEFAULT_HAI_PAYMENT_LINK;
