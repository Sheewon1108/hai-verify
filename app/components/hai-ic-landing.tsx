        ...
        <div className="mx-auto max-w-6xl px-6">
          <section id="pricing" className="py-16 border-t border-white/10">
            ...
            <p className="text-zinc-400 max-w-2xl mb-10 leading-relaxed">
              Deploy Hai-ic as a pre-execution Intent Confidence gate for Grok, Gemini, Claude, and internal agent stacks. Pricing: $300 Evaluation Pilot → OEM $8.5k+/yr → Enterprise $25k/yr.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
              <div className="bg-zinc-900 rounded-2xl p-6 border border-zinc-800">
                ...
                <p className="text-sm text-zinc-400 leading-relaxed">
                  Evaluation Pilot. Validate intent scoring in your workflow before OEM rollout.
                </p>
              </div>
          ...
          <section id="xai" className="py-16 border-t border-white/10">
            ...
            <div className="mt-10 rounded-2xl border border-red-accent/30 bg-red-accent/5 p-6">
              ...
              <p className="text-xs text-muted">Pricing: $300 Evaluation Pilot → OEM $8.5k+/yr → Enterprise $25k/yr · Status: Ready to Sell</p>
            </div>
          </section>
        </div>
      </main>
