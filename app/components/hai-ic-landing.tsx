...
/** HAI Verify Evaluation Pilot $300 — open Stripe Checkout only. No modal/form. */
        ...
        <div className="mx-auto max-w-6xl px-6">
          <section id="pricing" className="py-16 border-t border-white/10">
            ...
            <p className="text-zinc-400 max-w-2xl mb-10 leading-relaxed">
              Deploy Hai-ic as a pre-execution Intent Confidence gate for Grok, Gemini, Claude, and internal agent stacks. Start with a $300 Evaluation Pilot, then license OEM or Enterprise annually.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
              <div className="bg-zinc-900 rounded-2xl p-6 border border-zinc-800">
                ...
                <p className="text-sm text-zinc-400 leading-relaxed">
                  Fixed-scope evaluation of the Intent Confidence gate, threshold behavior, clarifying questions, and audit trail.
                </p>
              </div>
