...
const VERIFY: Record<AppLocale, VerifyCopy> = {
  en: {
    ...
    orderPrompt: "Need HAI to review a real AI command or workflow?",
    orderLink: "Start $300 Evaluation",
  ...
  ko: {
    ...
    summary: "요약",
    nextStep: "추천하는 다음 행동",
    orderPrompt: "실제 AI 명령이나 워크플로를 HAI가 검토하길 원하시나요?",
    orderLink: "Start $300 Evaluation",
  ...
  ja: {
    ...
    orderPrompt: "実際のAIコマンドやワークフローをHAIに評価してほしいですか？",
    orderLink: "Start $300 Evaluation",
  ...
  es: {
    ...
    orderPrompt: "¿Quiere que HAI evalúe un comando o flujo de trabajo real de IA?",
    orderLink: "Start $300 Evaluation",
  ...
  fr: {
    ...
    orderPrompt: "Voulez-vous que HAI évalue une vraie commande ou un vrai flux IA ?",
    orderLink: "Start $300 Evaluation",
